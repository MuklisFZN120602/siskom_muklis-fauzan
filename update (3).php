...
<html>
    ...
    <body>
    <header>
        <a style="border-style:solid; width:20px; height 20px; padding:10px; padding-top:20px; padding-left:10px; background:cadetblue; color: white; "href="index.php">HOME</a>
    </header>
    <div>
        <h1>Update</h1>
